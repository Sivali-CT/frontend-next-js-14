...
export default function Pricing() {
  return (
    <div className="bg-white py-24 sm:py-32 mx-auto max-w-7xl border-t border-gray-200">
          ...
          {tiers.map((tier, tierIdx) => (
            ...
            >
              <div>
                <div className="flex items-center justify-between gap-x-4">
                  <h3
                    id={tier.id}
                    className={classNames(
                      tier.mostPopular ? 'text-blue-700' : 'text-gray-900',
                  ...
                  {tier.mostPopular ? (
                    <p className="rounded-full bg-blue-700/10 px-2.5 py-1 text-xs font-semibold leading-5 text-blue-700">
                      Most popular
                    </p>
                  ) : null}
                </div>
              ...
              <a
                ...
                className={classNames(
                  tier.mostPopular
                    ? 'bg-blue-700 text-white shadow-sm hover:bg-blue-500'
                    : 'text-blue-700 ring-1 ring-inset ring-blue-200 hover:ring-blue-300',
